...
if (isset($_GET['del']) && is_numeric($_GET['del'])) {
    ...
    header('Location: clientes.php?ok=Cliente+exclu%C3%ADdo'); exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        header('Location: clientes.php?ok=Cliente+atualizado'); exit;
    } else {
        ...
        header('Location: clientes.php?ok=Cliente+cadastrado'); exit;
    }
}
