...
if (isset($_GET['del']) && is_numeric($_GET['del'])) {
    ...
    header('Location: ' . BASE_URL . '/pages/produtos.php?ok=Produto+exclu%C3%ADdo'); exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        header('Location: ' . BASE_URL . '/pages/produtos.php?ok=Produto+atualizado'); exit;
    } else {
        ...
        header('Location: ' . BASE_URL . '/pages/produtos.php?ok=Produto+cadastrado'); exit;
    }
}
