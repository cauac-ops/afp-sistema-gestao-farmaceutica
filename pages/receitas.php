...
if (isset($_GET['del']) && is_numeric($_GET['del'])) {
    ...
    header('Location: receitas.php?ok=Receita+exclu%C3%ADda'); exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        header('Location: receitas.php?ok=Receita+atualizada'); exit;
    } else {
        ...
        header('Location: receitas.php?ok=Receita+cadastrada'); exit;
    }
}

// MySQL: CURDATE() em vez de CURRENT_DATE
