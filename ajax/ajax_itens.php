...
?>
<p class="mb-2" style="font-size:13px;color:#6b7280">Venda #<?= $id ?> – <?= date('d/m/Y H:i', strtotime($v['data_venda'])) ?></p>
...
<p style="font-size:12px;color:#6b7280">Pagamento: <strong><?= $v['forma_pagamento'] ?></strong><?= $v['observacoes'] ? " | Obs: {$v['observacoes']}" : '' ?></p>
